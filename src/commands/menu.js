...
const commandDescriptions = {
  ...
  amistad: 'Calcula compatibilidad de amistad entre dos usuarios en modo meme.',
  crush: 'Calcula un match romántico de entretenimiento entre dos usuarios.',
  infiel: 'Muestra un porcentaje de infidelidad en modo meme; no afirma conducta real.',
  therian: 'Therianómetro de entretenimiento; no determina identidad real.',
  toxico: 'Muestra un nivel de toxicidad en modo meme.',
  celoso: 'Muestra un porcentaje de celos en modo meme.',
  intenso: 'Mide la intensidad del usuario en modo meme.',
  maldad: 'Muestra un porcentaje de maldad en modo meme.',
  inocente: 'Muestra un nivel de inocencia en modo meme.',
  suerte: 'Calcula la suerte del día del usuario.',
